# The Crop() is so that you don't have to manually crop it. 
# You may need to adjust this with the actual image you use to zoom in on the face, or part of the image you like.
...
# I usually like to set two versions: 
# One facing left and one facing right - again, all using the same source image "syd/syd_troll.png" and not having to manually crop, resize, or flip it.
